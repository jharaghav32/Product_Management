                                ...
                                <tr className="hover:bg-gray-100 dark:hover:bg-gray-700">
                                    ...
                                    <td className="p-4 space-x-2 whitespace-nowrap">
                                        <button
                                            ...
                                            onClick={()=>setshoweditproduct(!showeditproduct)}
                                        >
                                            <svg
...
<div
    ...
    className={`fixed top-0 right-0 z-40 w-full h-screen max-w-xs p-4 overflow-y-auto transition-transform ${showeditproduct?'transform-none':'translate-x-full'} bg-white dark:bg-gray-800`}
    tabindex="-1"
...
<div
    ...
    className={`fixed top-0 right-0 z-40 w-full h-screen max-w-xs p-4 overflow-y-auto transition-transform ${deleteproduct?'transform-none':'translate-x-full'} bg-white dark:bg-gray-800`}
    tabindex="-1"
    aria-labelledby="drawer-label"
    aria-hidden="true"
>
    ...
    <button
        ...
        aria-controls="drawer-delete-product-default"
        className="text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm p-1.5 absolute top-2.5 right-2.5 inline-flex items-center dark:hover:bg-gray-600 dark:hover:text-white"
        onClick={()=>handleClose(setdeleteproduct)}
    >
        <svg
            aria-hidden="true"
            className="w-5 h-5"
...
<div
    ...
    className={`fixed top-0 right-0 z-40 w-full h-screen max-w-xs p-4 overflow-y-auto transition-transform ${showproduct?'transform-none':'translate-x-full'} bg-white dark:bg-gray-800`}
    tabindex="-1"
    aria-labelledby="drawer-label"
    aria-hidden="true"
>
