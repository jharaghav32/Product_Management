...
const ModalForm = ({ onMetaChange, onSizeChange }) => {
  ...
  return /* @__PURE__ */ react.createElement(react.Fragment, null, metaFields, isResizable && sizeField);
};
ModalForm.propTypes = {
...
const CollectionTypeFormWrapper = ({ allLayoutData, children, slug, id, origin }) => {
  ...
  const onPost = (0,react.useCallback)(
    async (body, trackerProperty) => {
      const endPoint = typeof origin === "string" ? (0,utils/* getRequestUrl */.IF)(`collection-types/${slug}/clone/${origin}`) : (0,utils/* getRequestUrl */.IF)(`collection-types/${slug}`);
      try {
...
const TableRows = ({
  ...
  const ReviewWorkflowsStage = (0,useEnterprise/* useEnterprise */.c)(
    ...
    async () => (await __webpack_require__.e(/* import() */ 8697).then(__webpack_require__.bind(__webpack_require__, 18697))).ReviewWorkflowsStageEE,
    {
    ...
    return /* @__PURE__ */ react.createElement(
      ...
      headers.map(({ key, cellFormatter, name, ...rest }) => {
        ...
        if (hasReviewWorkflows && name === "strapi_reviewWorkflows_stage") {
          return /* @__PURE__ */ react.createElement(Cell.Td, { key }, data.strapi_reviewWorkflows_stage ? /* @__PURE__ */ react.createElement(
...
TableRows.propTypes = {
  ...
  features: prop_types_default().shape({
    hasDraftAndPublish: (prop_types_default()).bool.isRequired,
    hasReviewWorkflows: (prop_types_default()).bool.isRequired
  }).isRequired,
...
`;
const ListView_REVIEW_WORKFLOW_COLUMNS_CE = null;
function ListView({
  canCreate,
  canDelete,
  canRead,
  ...
  const reviewWorkflowColumns = (0,useEnterprise/* useEnterprise */.c)(
    ListView_REVIEW_WORKFLOW_COLUMNS_CE,
    async () => (await __webpack_require__.e(/* import() */ 5644).then(__webpack_require__.bind(__webpack_require__, 75644))).REVIEW_WORKFLOW_COLUMNS_EE,
    {
  ...
  const handleConfirmDeleteData = react.useCallback(
    async (idToDelete) => {
      try {
        ...
        const requestUrl = (0,utils/* getRequestUrl */.IF)(`collection-types/${slug}`);
  ...
  return /* @__PURE__ */ react.createElement(Main/* Main */.o, { "aria-busy": isLoading }, /* @__PURE__ */ react.createElement(
  ...
  ), /* @__PURE__ */ react.createElement(ContentLayout/* ContentLayout */.D, null, canRead ? /* @__PURE__ */ react.createElement(Flex/* Flex */.k, { gap: 4, direction: "column", alignItems: "stretch" }, /* @__PURE__ */ react.createElement(
    helper_plugin_esm/* DynamicTable */.tM,
    {
      ...
      layout,
      rows: data,
      components: { ConfirmDialogDelete: ConfirmDialogDelete, ConfirmDialogDeleteAll: ConfirmDialogDeleteAll_ConfirmDialogDeleteAll },
      ...
      renderBulkActionsBar: ({ selectedEntries, clearSelectedEntries }) => /* @__PURE__ */ react.createElement(
        DynamicTable_BulkActionsBar,
        {
