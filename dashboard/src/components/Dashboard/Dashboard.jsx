...
const Dashboard = () => {
	...
	console.log('thsi is orders',orders)
  return (
							...
							<tbody className="bg-white dark:bg-gray-800">
								{
									orders.map((order)=>(
										...
										>
											Payment from <span className="font-semibold">{order?.attributes?.email}</span>
										</td>
										<td
											className="p-4 text-sm font-normal text-gray-500 whitespace-nowrap dark:text-gray-400"
										>
											{formatDateAndTime(order?.attributes?.createdAt)}
										</td>
										<td
											className="p-4 text-sm font-semibold text-gray-900 whitespace-nowrap dark:text-white"
										>
											{order?.attributes?.products?.[0]?.attributes?.price}
										</td>
										<td
											className="p-4 text-sm font-normal text-gray-500 whitespace-nowrap dark:text-gray-400"
										>
											{order?.attributes?.stripeid}
										</td>
										{/* <td
