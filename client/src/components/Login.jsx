...
import {auth,provider} from '../hook/fireBase.js'
      ...
      <form action="" className="my-10">
        <div className="flex flex-col space-y-5">
          ...
          <label htmlFor="password">
            ...
            <input id="password" name="password" type="password" className="w-full py-3 border border-slate-200 rounded-lg px-3 focus:outline-none focus:border-slate-500 hover:shadow" placeholder="Enter your password" value={password} onChange={handleChange}/>
          </label>
          ...
          <p className="text-center">Not registered yet? <a href="/register" className="text-indigo-600 font-medium inline-flex space-x-1 items-center"><span>Register now </span><span><svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2">
