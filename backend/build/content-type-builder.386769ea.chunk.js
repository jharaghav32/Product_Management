...
const FormModalHeader = ({
  ...
  return /* @__PURE__ */ react.createElement(ModalHeader/* ModalHeader */.x, null, /* @__PURE__ */ react.createElement(Flex/* Flex */.k, { gap: 3 }, showBackLink && /* @__PURE__ */ react.createElement(helper_plugin_esm/* Link */.rU, { "aria-label": "Back", startIcon: /* @__PURE__ */ react.createElement(ArrowLeft/* default */.Z, null), onClick: () => onOpenModalAddField({ forTarget, targetUid }), to: "#back" }), /* @__PURE__ */ react.createElement(AttributeIcon/* default */.Z, { type: icon, customField: customFieldUid }), /* @__PURE__ */ react.createElement(Breadcrumbs/* Breadcrumbs */.O, { label: headers.map(({ label }) => label).join(",") }, headers.map(({ label, info }, index, arr) => {
